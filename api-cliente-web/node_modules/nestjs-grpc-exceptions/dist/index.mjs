...
var GRPC_CODE_FROM_HTTP = {
  [HttpStatus2.OK]: Status2.OK,
  [HttpStatus2.BAD_GATEWAY]: Status2.UNKNOWN,
  [HttpStatus2.UNPROCESSABLE_ENTITY]: Status2.INVALID_ARGUMENT,
  [HttpStatus2.REQUEST_TIMEOUT]: Status2.DEADLINE_EXCEEDED,
  [HttpStatus2.NOT_FOUND]: Status2.NOT_FOUND,
  [HttpStatus2.CONFLICT]: Status2.ALREADY_EXISTS,
  [HttpStatus2.FORBIDDEN]: Status2.PERMISSION_DENIED,
  [HttpStatus2.TOO_MANY_REQUESTS]: Status2.RESOURCE_EXHAUSTED,
  [HttpStatus2.PRECONDITION_REQUIRED]: Status2.FAILED_PRECONDITION,
  [HttpStatus2.METHOD_NOT_ALLOWED]: Status2.ABORTED,
  [HttpStatus2.PAYLOAD_TOO_LARGE]: Status2.OUT_OF_RANGE,
  [HttpStatus2.NOT_IMPLEMENTED]: Status2.UNIMPLEMENTED,
  [HttpStatus2.INTERNAL_SERVER_ERROR]: Status2.INTERNAL,
  [HttpStatus2.UNAUTHORIZED]: Status2.UNAUTHENTICATED
};
    ...
    return next.handle().pipe(
      (0, import_operators.catchError)((err) => {
        ...
        if (exception.exceptionName !== RpcException14.name)
          return (0, import_rxjs2.throwError)(() => err);
        const statusCode = HTTP_CODE_FROM_GRPC[err.code] || HttpStatus3.INTERNAL_SERVER_ERROR;
        return (0, import_rxjs2.throwError)(
          () => new HttpException(
            {
              message: exception.error,
              statusCode,
              error: HttpStatus3[statusCode]
            },
            statusCode,
            {
              cause: err
...
import { status as Status3 } from "@grpc/grpc-js";
import { RpcException as RpcException15 } from "@nestjs/microservices";
  ...
  intercept(_context, next) {
    return next.handle().pipe(
      (0, import_operators2.catchError)((err) => {
        ...
        const statusCode = GRPC_CODE_FROM_HTTP[exception.statusCode] || Status3.INTERNAL;
