...
var GRPC_CODE_FROM_HTTP = {
  [import_common3.HttpStatus.OK]: import_grpc_js2.status.OK,
  [import_common3.HttpStatus.BAD_GATEWAY]: import_grpc_js2.status.UNKNOWN,
  [import_common3.HttpStatus.UNPROCESSABLE_ENTITY]: import_grpc_js2.status.INVALID_ARGUMENT,
  [import_common3.HttpStatus.REQUEST_TIMEOUT]: import_grpc_js2.status.DEADLINE_EXCEEDED,
  [import_common3.HttpStatus.NOT_FOUND]: import_grpc_js2.status.NOT_FOUND,
  [import_common3.HttpStatus.CONFLICT]: import_grpc_js2.status.ALREADY_EXISTS,
  [import_common3.HttpStatus.FORBIDDEN]: import_grpc_js2.status.PERMISSION_DENIED,
  [import_common3.HttpStatus.TOO_MANY_REQUESTS]: import_grpc_js2.status.RESOURCE_EXHAUSTED,
  [import_common3.HttpStatus.PRECONDITION_REQUIRED]: import_grpc_js2.status.FAILED_PRECONDITION,
  [import_common3.HttpStatus.METHOD_NOT_ALLOWED]: import_grpc_js2.status.ABORTED,
  [import_common3.HttpStatus.PAYLOAD_TOO_LARGE]: import_grpc_js2.status.OUT_OF_RANGE,
  [import_common3.HttpStatus.NOT_IMPLEMENTED]: import_grpc_js2.status.UNIMPLEMENTED,
  [import_common3.HttpStatus.INTERNAL_SERVER_ERROR]: import_grpc_js2.status.INTERNAL,
  [import_common3.HttpStatus.UNAUTHORIZED]: import_grpc_js2.status.UNAUTHENTICATED
};

// lib/exceptions/not-found.exception.ts
var GrpcNotFoundException = class extends import_microservices3.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js3.status.NOT_FOUND));
  }
};
...
var GrpcAbortedException = class extends import_microservices4.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js4.status.ABORTED));
  }
};
...
var GrpcUnknownException = class extends import_microservices5.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js5.status.UNKNOWN));
  }
};
...
var GrpcInternalException = class extends import_microservices6.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js6.status.INTERNAL));
  }
};
...
var GrpcUnavailableException = class extends import_microservices7.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js7.status.UNAVAILABLE));
  }
};
...
var GrpcUnauthenticatedException = class extends import_microservices8.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js8.status.UNAUTHENTICATED));
  }
};
...
var GrpcPermissionDeniedException = class extends import_microservices9.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js9.status.PERMISSION_DENIED));
  }
};
...
var GrpcInvalidArgumentException = class extends import_microservices10.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js10.status.INVALID_ARGUMENT));
  }
};
...
var GrpcResourceExhaustedException = class extends import_microservices11.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js11.status.RESOURCE_EXHAUSTED));
  }
};
...
var GrpcAlreadyExistsException = class extends import_microservices12.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js12.status.ALREADY_EXISTS));
  }
};

// lib/exceptions/cancelled.exception.ts
var import_grpc_js13 = require("@grpc/grpc-js");
...
var GrpcCancelledException = class extends import_microservices13.RpcException {
  constructor(error) {
    super(errorObject(error, import_grpc_js13.status.CANCELLED));
  }
};
    ...
    return next.handle().pipe(
      (0, import_operators.catchError)((err) => {
        ...
        if (exception.exceptionName !== import_microservices14.RpcException.name)
          return (0, import_rxjs2.throwError)(() => err);
        const statusCode = HTTP_CODE_FROM_GRPC[err.code] || import_common4.HttpStatus.INTERNAL_SERVER_ERROR;
        return (0, import_rxjs2.throwError)(
          () => new import_common4.HttpException(
            {
              message: exception.error,
              statusCode,
              error: import_common4.HttpStatus[statusCode]
            },
            statusCode,
            {
              cause: err
...
var import_grpc_js14 = require("@grpc/grpc-js");
var import_microservices15 = require("@nestjs/microservices");
  ...
  intercept(_context, next) {
    return next.handle().pipe(
      (0, import_operators2.catchError)((err) => {
        ...
        const statusCode = GRPC_CODE_FROM_HTTP[exception.statusCode] || import_grpc_js14.status.INTERNAL;
        return (0, import_rxjs3.throwError)(
          () => new import_microservices15.RpcException({
