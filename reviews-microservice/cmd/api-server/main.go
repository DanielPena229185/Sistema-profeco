...
import (
	...
	"github.com/silverflin/Sistema-profeco/reviews-microservice/internal/services"
...
func main() {
	...
	pb.RegisterReviewsServer(grpcServer, newServer())
	grpcServer.Serve(lis)
}

func newServer() *services.ReviewsServer {
	s := &services.ReviewsServer{}
	return s
}
